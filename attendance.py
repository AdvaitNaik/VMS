...
image=PhotoImage(file="C:\\Users\\ADMIN\\Desktop\\Attendance-System-Main\\Bg_image.png")
...
trackImg = tk.Button(window, text="CHECK TEMPERATURE", command="" ,fg="white"  ,bg="black"  ,width=25  ,height=2, activebackground = "white" ,font=('Times New Roman', 15, ' bold '))
